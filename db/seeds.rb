...
# end
 ...
 4.times do
  ...
  category_id  = 5
  producer_id  = 2
  Product.create({title: "#{title}"+category_id.to_s,description: description,price:price,sku:sku,quantity:1,category:Category.all.sample,producer:Producer.all.sample})
end
